...
| `post_attachments` | 게시글당 1개 첨부파일 메타데이터 |
| `admins` | 관리자 계정 |
...
| `V4__create_post_attachments_table.sql` | 첨부파일 테이블 생성, 게시글당 1개 unique 제약 |
...
- `post_attachments.post_id`는 unique입니다. 게시글당 첨부파일은 1개만 허용합니다.
